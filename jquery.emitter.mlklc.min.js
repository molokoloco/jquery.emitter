...
0.5?l:n):(e.marginLeft=Math.random()<0.5?k:m,e.marginTop=c.getRand(l,n))}if(!b[d][f]||b[d][f].length<1)b[d][f]=c(a.element).appendTo(i);c.data(b[d][f],"used",1);b[d][f].crossCss(s);i.trigger("emit",[b[d][f]]);setTimeout(p.applyCssEnd,0,d,f,e)}f=void 0;s=void 0;e=void 0;k=void 0;l=void 0;m=void 0;n=void 0;a.delay?o=setTimeout(t,a.delay):b.requestAnimFrame(t)}};i.bind(q);i.trigger("start");return i})};c.fn.emitter.options={effect:"nebula",transition:"all 1000ms linear",newAtTop:"random",emitterRadius:0,
emitterCenterLeft:null,emitterCenterTop:null,delay:null,maxSprite:30,element:"<div></div>",position:"absolute",display:"block",zIndex:500,cssFrom:{width:"10%",maxSize:null},cssTo:{}}})(jQuery,window);